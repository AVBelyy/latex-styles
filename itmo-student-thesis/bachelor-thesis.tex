...
\author{Буздалов Максим Викторович}{Буздалова Максима Викторовича}{Буздалов М.В.}{Буздалову М.В.}
...
\addtechnologyusage{Пакет \texttt{algorithmicx}}{\ref{section:listings}}
\addtechnologyusage{Пакет \texttt{tabu}}{\ref{chapter2}}
...
\section{Листинги}\label{section:listings}
...
\chapter{Проверка сквозной нумерации}\label{chapter2}
